...
import { BookOpen, SearchX, AlertCircle } from 'lucide-react';

const Research = () => {
  return (
    <section id="domain" className="section-padding relative overflow-hidden">
      <div className="container mx-auto px-6 max-w-7xl relative z-10">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-16">
          ...
          <p className="text-lg text-slate-500 dark:text-slate-400 max-w-2xl mx-auto">
            Literature survey, research gaps, and the core problem this project addresses.
          </p>
        </motion.div>
          ...
          >
            ...
            <div className="relative p-8 md:p-10 h-full flex flex-col justify-end">
              <div className="inline-flex items-center gap-2 bg-blue-500/20 backdrop-blur-md w-fit px-4 py-2 rounded-full border border-blue-400/30 text-blue-300 text-sm font-bold mb-4">
                <BookOpen size={16} /> Literature Survey
              </div>
        ...
        >
          ...
          <div className="relative p-8 md:p-10 h-full flex flex-col justify-end">
            <div className="inline-flex items-center gap-2 bg-amber-500/20 backdrop-blur-md w-fit px-4 py-2 rounded-full border border-amber-400/30 text-amber-300 text-sm font-bold mb-4">
              <AlertCircle size={16} /> Research Problem
            </div>
            <p className="text-slate-100 text-lg leading-relaxed font-medium max-w-4xl">
              How can an integrated, AI-driven mobile ecosystem simultaneously address idle land misclassification, subjective cultivator screening, supply chain volatility, and market pricing inequity to empower smallholder spice farmers in Sri Lanka with data-driven decision support at every stage of the agricultural value chain?
            </p>
          </div>
        </motion.div>
      </div>
